...
const DropDown = ({ data }: any) => {
    return (
        <div>
            ...
            <DropdownButton icon={<Security />} buttonText={data.basket.guarantee} dropdownText={data.basket.dropdown2} />
            <DropdownButton icon={<Lock />} buttonText={data.basket.privacy} dropdownText={data.basket.dropdown3} />
        </div>
    )
}
