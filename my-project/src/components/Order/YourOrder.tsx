    ...
    return (
        <div className='w-[357px] h-[405px] py-10 px-4 border-[1px] bg-white border-[#DCDCDC] drop-shadow-[4px_15px_40px_0px_#100E0C33] rounded'>
            ...
            <ul className='border-b-[1px] border-[#292D2D] mb-6'>
                <li className='mb-2 flex justify-between'><p className='text-t16'>{data.order.total}</p> <p className='text-t18'>{total} ₴</p></li>
                <li className='mb-2 flex justify-between'><p className='text-t16'> {data.order.delivery}</p> <p className='text-t18'>{deliveryPrice} ₴</p></li>
                <li className='mb-2 flex justify-between'><p className='text-t16'>{data.order.discount}</p> <p className='text-t18'>- 0 ₴</p></li>
            </ul>
            <div className='flex justify-between mb-8'> <p className='text-t18'>{data.order.totalAmountToBePaid}</p> <p className='text-t18'>{allTotal} ₴</p></div>
            {personActive && (
